                        ...
                        <div className="flex-1 !p-2">
                            ...
                            {activeTab === 'theme' && (
                                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                                    ...
                                    {/* Recommended Luxury Color Palettes */}
                                    <div className="!mb-6 !p-4 bg-gray-50 border border-gray-200 rounded-xl">
                                        <label className="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">
                                            Curated Luxury Theme Presets (Auto Contrast)
                                        </label>
                                        <div className="grid grid-cols-2 md:grid-cols-6 gap-2.5">
                                            {[
                                                { name: 'Obsidian Dark', bg: '#0a0a0a', text: '#ffffff', accent: '#c4a35a' },
                                                { name: 'Midnight Navy', bg: '#0b1326', text: '#ffffff', accent: '#3b82f6' },
                                                { name: 'Imperial Emerald', bg: '#0c1c14', text: '#ffffff', accent: '#10b981' },
                                                { name: 'Champagne Light', bg: '#f9f6f0', text: '#1a1a1a', accent: '#c4a35a' },
                                                { name: 'Velvet Platinum', bg: '#f4f5f7', text: '#1a1a1a', accent: '#6366f1' },
                                                { name: 'Pearl White', bg: '#ffffff', text: '#1a1a1a', accent: '#d97706' },
                                            ].map((preset, idx) => (
                                                <button
                                                    key={idx}
                                                    type="button"
                                                    ...
                                                    className="flex flex-col items-center !p-2.5 rounded-lg border border-gray-200 hover:border-black transition-all cursor-pointer bg-white text-left shadow-sm group"
                                                >
                                                    <div className="w-full h-7 rounded border border-gray-300 flex items-center justify-center text-[10px] font-bold mb-1.5" style={{ background: preset.bg, color: preset.text }}>
                                                        Aa
                                                    </div>
                                                    <span className="text-[10px] font-semibold text-gray-700 group-hover:text-black truncate w-full text-center">{preset.name}</span>
                                                </button>
                                            ))}
                                        </div>
                                    </div>
