...
export function getFileUrl(path) {
  ...
  const isFrontendStatic = cleanPath.startsWith('/assets/') || cleanPath.startsWith('assets/') ||
    ...
    cleanPath.match(/^\/?(fylex_logo|fylex_logo_name|logo|fylex|Rim|Watch_1|dial1|rim1|footer_logo|auth-hero|login-models|registration-welcome|Origin)\.(png|webp|jpg|jpeg|svg)$/i) ||
