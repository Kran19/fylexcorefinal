    ...
    <div className="auth-page">
      ...
      <main className="auth-main">
        ...
        <div className={`auth-form-panel ${loaded ? 'auth-loaded' : ''}`}>
          <div className={`auth-form-inner ${shake ? 'auth-shake' : ''}`}>
            ...
            {step === 1 && (
              <>
                <h1 className="auth-title">Enter The World of Fylex</h1>
      ...
      <style>{`
        ...
        .auth-image-overlay {
          ...
          background: linear-gradient(to right, transparent 70%, #000000 100%), linear-gradient(to top, #000000 0%, transparent 22%);
          pointer-events: none;
        }
