...
const injectLogo = (text: string) => {
  if (!text) return '';
  return text.replace(/(Fylexx|Fylex|FYLEXX|FYLEX)/gi, '<img src="/preload/fylex_logo_name.png" alt="$1" style="height: 0.7em; display: inline-block; vertical-align: middle; transform: translateY(-0.1em); filter: invert(1);" />');
};
