...
if (typeof window !== 'undefined') {
  try {
    ...
    if (isLocalHost) {
      ...
      BASE_URL = `${protocol}//${hostname}/api`;
    }
  } catch (e) {
...
export const getPurgePreview = () => get('/media/optimization/purge-preview');
export const executePurgeMedia = (data) => post('/media/optimization/purge', data);
